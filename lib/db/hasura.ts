...
export async function createNewUser(
	token: any,
	metadata: { issuer: any; email: any; publicAddress: any }
) {
	const operationsDoc = `
...
export async function isNewUser(token: any, issuer: string) {
	const operationsDoc = `
...
export async function getWatchedVideos(userId: string, token: any) {
	const operationsDoc = `
...
export async function getMyListVideos(userId: string, token: any) {
	const operationsDoc = `
